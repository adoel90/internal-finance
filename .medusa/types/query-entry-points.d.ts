...
export enum PaymentCollectionStatusEnum {
  NotPaid = 'NOT_PAID',
  Awaiting = 'AWAITING',
...
export type PaymentCollection = {
  ...
  currency_code: Scalars['String']['output'];
  amount: Scalars['String']['output'];
  authorized_amount: Maybe<Scalars['String']['output']>;
  captured_amount: Maybe<Scalars['String']['output']>;
  refunded_amount: Maybe<Scalars['String']['output']>;
  completed_at: Maybe<Scalars['DateTime']['output']>;
...
export enum SaldoAvailableCurrencyCodeEnum {
  Rp = 'RP',
   = '_'
}

export type SaldoAvailable = {
  __typename?: 'SaldoAvailable';
  id: Scalars['ID']['output'];
  amount: Scalars['Int']['output'];
  currency_code: Maybe<SaldoAvailableCurrencyCodeEnum>;
  created_note_at: Maybe<Scalars['DateTime']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export enum SaldoAllbankCurrencyCodeEnum {
  Rp = 'RP',
   = '_'
}

export type SaldoAllbank = {
  ...
  currency_code: Maybe<SaldoAllbankCurrencyCodeEnum>;
  amount_saldo: Scalars['Int']['output'];
  updated_saldo_at: Scalars['DateTime']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export type SaldoAllrekening = {
  ...
  keterangan: Maybe<Scalars['String']['output']>;
  allowed_see: Maybe<Scalars['Boolean']['output']>;
  histories: Array<Maybe<SaldoHistory>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export type SaldoTersedia = {
  ...
  keterangan: Maybe<Scalars['String']['output']>;
  allowed_see: Maybe<Scalars['Boolean']['output']>;
  histories_saldo_tersedia: Array<Maybe<SaldoHistoryTersedia>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export enum SaldoHistoryTersediaCurrencyCodeEnum {
  Rp = 'RP',
   = '_'
}

export type SaldoHistoryTersedia = {
  __typename?: 'SaldoHistoryTersedia';
  id: Scalars['ID']['output'];
  currency_code: Maybe<SaldoHistoryTersediaCurrencyCodeEnum>;
  amount_saldo_history_tersedia_id: Scalars['String']['output'];
  amountSaldoHistoryTersedia: SaldoTersedia;
  amount: Scalars['Int']['output'];
  updated_saldo_at: Maybe<Scalars['DateTime']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export enum SaldoHistoryCurrencyCodeEnum {
  Rp = 'RP',
   = '_'
}

export type SaldoHistory = {
  __typename?: 'SaldoHistory';
  id: Scalars['ID']['output'];
  currency_code: Maybe<SaldoHistoryCurrencyCodeEnum>;
  amount_saldo_id: Scalars['String']['output'];
  amountSaldo: SaldoAllrekening;
  amount: Scalars['Int']['output'];
  updated_saldo_at: Maybe<Scalars['DateTime']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
...
export enum PenerimaanCurrencyCodeEnum {
  Rp = 'RP',
   = '_'
}

export enum PenerimaanAmountOfInflowForEnum {
  SttMahasiswaBerbayar = 'STT__MAHASISWA_BERBAYAR_',
  SttHibahBeastudi = 'STT__HIBAH_BEASTUDI_',
  SttMahasiswaBaru = 'STT__MAHASISWA_BARU_',
  NfAcademy = 'NF_ACADEMY',
  OtherStt = 'OTHER__STT_',
  OtherNfAcademy = 'OTHER__NF_ACADEMY_'
}

export type Penerimaan = {
  __typename?: 'Penerimaan';
  id: Scalars['ID']['output'];
  payment_method: Scalars['String']['output'];
  amount: Scalars['Int']['output'];
  currency_code: Maybe<PenerimaanCurrencyCodeEnum>;
  description: Maybe<Scalars['String']['output']>;
  created_note_at: Scalars['DateTime']['output'];
  amount_of_inflow_for: Maybe<PenerimaanAmountOfInflowForEnum>;
  keterangan_tambahan: Maybe<Scalars['String']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export enum PengeluaranCurrencyCodeEnum {
  Rp = 'RP',
   = '_'
}

export enum PengeluaranAmountOfOutflowForEnum {
  SttPenggajianDanThr = 'STT__PENGGAJIAN_DAN_THR_',
  NfAcademyPenggajianDanThr = 'NF_ACADEMY__PENGGAJIAN_DAN_THR_',
  SttOperasional = 'STT__OPERASIONAL_',
  NfAcademyOperasional = 'NF_ACADEMY__OPERASIONAL_',
  SttPengembalian = 'STT__PENGEMBALIAN_',
  NfAcademyPengembalian = 'NF_ACADEMY__PENGEMBALIAN_',
  OtherStt = 'OTHER__STT_',
  OtherNfAcademy = 'OTHER__NF_ACADEMY_'
}

export type Pengeluaran = {
  __typename?: 'Pengeluaran';
  id: Scalars['ID']['output'];
  payment_method: Scalars['String']['output'];
  amount: Scalars['Int']['output'];
  currency_code: Maybe<PengeluaranCurrencyCodeEnum>;
  description: Maybe<Scalars['String']['output']>;
  created_note_at: Scalars['DateTime']['output'];
  amount_of_outflow_for: Maybe<PengeluaranAmountOfOutflowForEnum>;
  keterangan_tambahan: Maybe<Scalars['String']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
...
export enum PengeluaranProyeksiCashcallAmountOfInflowForEnum {
  SttMahasiswaBerbayar = 'STT__MAHASISWA_BERBAYAR_',
  SttHibahBeastudi = 'STT__HIBAH_BEASTUDI_',
  SttMahasiswaBaru = 'STT__MAHASISWA_BARU_',
  NfAcademy = 'NF_ACADEMY',
...
export type PengeluaranProyeksiCashcall = {
  __typename?: 'PengeluaranProyeksiCashcall';
  id: Scalars['ID']['output'];
  created_note_at: Scalars['DateTime']['output'];
  amount_of_inflow_for: Maybe<PengeluaranProyeksiCashcallAmountOfInflowForEnum>;
  amount: Scalars['Int']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    saldo_availables: SaldoAvailable
    saldo_allbank: SaldoAllbank
    saldo_allbanks: SaldoAllbank
    saldo_allrekening: SaldoAllrekening
    saldo_allrekenings: SaldoAllrekening
    saldo_tersedia: SaldoTersedia
    saldo_tersedias: SaldoTersedia
    saldo_history_tersedia: SaldoHistoryTersedia
    saldo_history_tersedias: SaldoHistoryTersedia
    ...
    pengeluaran_proyeksi_cashcall: PengeluaranProyeksiCashcall
    pengeluaran_proyeksi_cashcalls: PengeluaranProyeksiCashcall
    post: Post
    posts: Post
